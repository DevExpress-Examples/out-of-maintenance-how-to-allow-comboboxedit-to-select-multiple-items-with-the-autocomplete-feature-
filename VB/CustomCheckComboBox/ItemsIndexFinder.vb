...
Namespace CustomCheckComboBox
    ...
    Public Class ItemsIndexFinder
        ...
        Public Overloads Function FindItemIndexByText(ByVal items As List(Of String), ByVal isCaseSensitive As Boolean, ByVal autoComplete As Boolean) As List(Of Integer)
        ...
        Private Overloads Function FindItemIndexByTextInternal(ByVal text As String, ByVal isCaseSensitive As Boolean, ByVal autoComplete As Boolean) As List(Of Integer)
