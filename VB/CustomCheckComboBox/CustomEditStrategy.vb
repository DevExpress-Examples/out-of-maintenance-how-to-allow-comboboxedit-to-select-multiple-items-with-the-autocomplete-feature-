...
Namespace CustomCheckComboBox
	Friend Class CustomEditStrategy
		...
		Private Function CheckIsSeparatorInEndOfString(ByVal text As String) As Boolean
            ...
            If items.Last().Length = 1 AndAlso FindItemIndexByText(items.Last()) = -1 Then
        ...
        Public Overloads Function FindItemIndexByText(ByVal items As List(Of String)) As List(Of Integer)
        ...
        Public Overrides Function FindItemIndexByText(ByVal text As String) As Integer
            Return ItemsProvider.FindItemIndexByText(text, CurrentEditor.IsCaseSensitiveSearch, CurrentEditor.AutoComplete)
        End Function
		...
		Private Function ValidateLastItemBeforeRefresh(ByVal editText As String, ByVal editValuesIndexes As List(Of Integer)) As Integer
			...
			Array.Reverse(array)
			Dim indexes As List(Of Integer) = FindItemIndexByText(New List(Of String) (New String() {New String(array)}))
			...
			If e.Key = Key.Back AndAlso searchItems.Count > 1 Then
				If CurrentEditor.SelectionStart = 0 Then
                    ...
                    If CurrentEditor.SelectionLength = 0 Then
                        CurrentEditor.SelectionLength = 1
                    Else
                        CurrentEditor.SelectionLength = CurrentEditor.SelectionLength + 1
