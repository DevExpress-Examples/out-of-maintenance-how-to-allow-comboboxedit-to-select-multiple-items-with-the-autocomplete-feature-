...
Namespace CustomCheckComboBox
    ...
    Public Class CustomComboBoxEditSettings
        ...
        Public Shared Sub RegisterCustomEdit()
            Call EditorSettingsProvider.Default.RegisterUserEditor(GetType(CustomComboBoxEdit), GetType(CustomComboBoxEditSettings), Function() New CustomComboBoxEdit(), Function() New CustomComboBoxEditSettings())
        End Sub
    End Class
End Namespace
